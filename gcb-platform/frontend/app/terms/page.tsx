      ...
      <Card>
        ...
        <CardContent className="prose prose-sm max-w-none dark:prose-invert">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mt-6 mb-3 text-foreground">1. Acceptance of Terms</h2>
          ...
          {/* Section 2 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold mt-6 mb-3 text-foreground">2. Description of Service</h2>
            
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">2.1 What We Provide</h3>
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">2.2 Important Disclaimers</h3>
            <p className="text-muted-foreground">
              <strong className="text-foreground">This benchmark is for informational purposes only</strong> and does not constitute an endorsement 
              or recommendation of any AI model or service.
            </p>
            <p className="text-muted-foreground">
              <strong className="text-foreground">Results reflect performance</strong> on specific test questions at a point in time and may not 
              predict performance on other tasks or future model versions.
            </p>
            <p className="text-muted-foreground">
              <strong className="text-foreground">The Great Commission Benchmark is an independent project</strong> and is not affiliated with 
          ...
          {/* Section 3 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold mt-6 mb-3 text-foreground">3. User Accounts and Registration</h2>
            
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">3.1 Account Creation</h3>
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">3.2 Account Eligibility</h3>
            <p className="text-muted-foreground">
          ...
          {/* Section 4 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold mt-6 mb-3 text-foreground">4. User Obligations and Acceptable Use</h2>
            
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">4.1 Acceptable Use</h3>
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">4.2 Tester Agreement and Confidentiality</h3>
            <p className="text-muted-foreground mb-2">If you run benchmark tests, you must agree to additional confidentiality terms:</p>
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
              <li><strong className="text-foreground">No public sharing:</strong> You may not post test questions online or in public forums</li>
              <li><strong className="text-foreground">No provider sharing:</strong> You may not share questions with AI companies or model providers</li>
              <li><strong className="text-foreground">No training use:</strong> You may not use questions to train or fine-tune models</li>
              <li><strong className="text-foreground">Report leaks:</strong> You must report any suspected breaches of question confidentiality</li>
            </ul>
          ...
          {/* Section 5 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold mt-6 mb-3 text-foreground">5. Payment Terms</h2>
            
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">5.1 Pricing</h3>
            <p className="text-muted-foreground mb-2">The Service charges fees for running benchmark tests. Pricing includes:</p>
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
              <li><strong className="text-foreground">API costs:</strong> Pass-through costs for input and output tokens based on the selected model</li>
              <li><strong className="text-foreground">Benchmark hosting contribution:</strong> A fixed $20 contribution per test to cover infrastructure and operations</li>
              <li><strong className="text-foreground">Optional round-up:</strong> You may optionally round up your payment to support the initiative</li>
            </ul>
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">5.2 Payment Processing</h3>
            <p className="text-muted-foreground">
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">5.3 Refund Policy</h3>
            <p className="text-muted-foreground mb-2">Refunds are available in the following circumstances:</p>
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
              <li><strong className="text-foreground">Test failed to complete:</strong> If a test fails due to technical issues</li>
              <li><strong className="text-foreground">Test stuck in error state:</strong> If a test becomes stuck and cannot complete</li>
              <li><strong className="text-foreground">User reports issue before completion:</strong> If you report a problem before the test finishes</li>
            </ul>
            <p className="text-muted-foreground mt-3 mb-2">Refunds are <strong className="text-foreground">not available</strong> for:</p>
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">5.4 No Guarantee of Results</h3>
            <p className="text-muted-foreground">
          ...
          {/* Section 6 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold mt-6 mb-3 text-foreground">6. Intellectual Property</h2>
            
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">6.1 Our Intellectual Property</h3>
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">6.2 Open Source Components</h3>
            <p className="text-muted-foreground">
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">6.3 User-Submitted Content</h3>
            <p className="text-muted-foreground">
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">6.4 Published Results</h3>
            <p className="text-muted-foreground">
          ...
          {/* Section 7 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold mt-6 mb-3 text-foreground">7. Privacy and Data</h2>
            
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">7.1 Data Collection</h3>
            <p className="text-muted-foreground">
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">7.2 Data Sharing</h3>
            <p className="text-muted-foreground mb-2">We may share data with:</p>
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
              <li><strong className="text-foreground">Public:</strong> Aggregate results published on leaderboards</li>
              <li><strong className="text-foreground">Researchers:</strong> Anonymized data for research purposes (upon request)</li>
              <li><strong className="text-foreground">Model providers:</strong> Their own model&apos;s results for transparency</li>
              <li><strong className="text-foreground">Moderators:</strong> Full test data for verification purposes</li>
            </ul>

            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">7.3 Data Retention</h3>
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
          ...
          {/* Section 8 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold mt-6 mb-3 text-foreground">8. Disclaimers and Limitation of Liability</h2>
            
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">8.1 Service Provided &quot;As Is&quot;</h3>
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">8.2 No Warranties</h3>
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">8.3 Results Disclaimer</h3>
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">8.4 Third-Party Services</h3>
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">8.5 Limitation of Liability</h3>
          ...
          {/* Section 9 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold mt-6 mb-3 text-foreground">9. Indemnification</h2>
            <p className="text-muted-foreground mb-2">
          ...
          {/* Section 10 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold mt-6 mb-3 text-foreground">10. Termination</h2>
            
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">10.1 Termination by You</h3>
            <p className="text-muted-foreground">
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">10.2 Termination by Us</h3>
            <p className="text-muted-foreground mb-2">
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">10.3 Effect of Termination</h3>
          ...
          {/* Section 11 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold mt-6 mb-3 text-foreground">11. Modifications to the Service</h2>
          ...
          {/* Section 12 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold mt-6 mb-3 text-foreground">12. Dispute Resolution</h2>
            
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">12.1 Governing Law</h3>
            <p className="text-muted-foreground">
              These Terms shall be governed by and construed in accordance with the laws of the State of Texas, 
              United States, without regard to its conflict of law provisions.
            </p>

            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">12.2 Dispute Process</h3>
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">12.3 Informal Resolution</h3>
            <p className="text-muted-foreground">
          ...
          {/* Section 13 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold mt-6 mb-3 text-foreground">13. General Provisions</h2>
            
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">13.1 Entire Agreement</h3>
            <p className="text-muted-foreground">
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">13.2 Severability</h3>
            <p className="text-muted-foreground">
              If any provision of these Terms is found to be unenforceable, the remaining provisions will remain 
              in full force and effect.
            </p>

            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">13.3 Waiver</h3>
            <p className="text-muted-foreground">
              Our failure to enforce any provision of these Terms does not constitute a waiver of that provision 
              or any other provision.
            </p>

            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">13.4 Assignment</h3>
            <p className="text-muted-foreground">
            ...
            <h3 className="text-lg font-medium mt-4 mb-2 text-foreground">13.5 Contact Information</h3>
            <p className="text-muted-foreground">
          ...
          <section className="mb-4 p-4 bg-muted rounded-lg">
            <h2 className="text-xl font-semibold mb-3 text-foreground">14. Acknowledgment</h2>
