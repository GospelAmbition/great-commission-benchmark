...
// POST /api/admin/versions/[version]/empty - empty all questions from a version
export async function POST(
  ...
  try {
    ...
    // Now empty the question set
    const response = await fetch(
      `${API_URL}/api/admin/question-sets/${questionSet.id}/empty`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
