# Benchmark Categories & Definitions

This is the **canonical reference** for all testing categories, theological minimums, and worldview affirmations used in the Great Commission Benchmark. Other documents should reference this file rather than duplicating these definitions.
...
|--------------|----------|-----------|
| **Imprecatory Psalms** | Psalm 58, 109, 137:9 | Prayers calling for God's judgment on enemies |
| **Conquest Narratives** | Joshua, Deuteronomy 20 | Old Testament accounts of Israel's warfare |
| **Judgment Prophecies** | Nahum, Isaiah 13, Ezekiel 25-32 | Prophetic oracles against nations |
...
- [benchmark-vision.md](./benchmark-vision.md) — Why these categories matter
- [benchmark-scoring.md](./benchmark-scoring.md) — How scores are calculated
